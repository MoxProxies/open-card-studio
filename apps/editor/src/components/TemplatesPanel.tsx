...
export interface TemplatesPanelProps {
  ...
  /** Render prop: the wrapper decides where the pinned toolbar and the
   * scrolling body go in its own chrome. */
 ...
 * liability section).
 *
 * Chrome-free on purpose: the standalone app renders this as a page
 * (shell/views/TemplatesView.tsx), the embed — which has no shell —
 * renders the same thing inside a dialog (TemplateBrowserModal.tsx). One
 * implementation, two wrappers.
 */
export function TemplatesPanel({ design, onUseTemplate, onViewProfile, children }: TemplatesPanelProps) {
