...
export interface LibraryPanelProps {
  ...
  /** Render prop — see TemplatesPanel for why these panels are chrome-free. */
 ...
 */
export function LibraryPanel({ design, onRename, onSave, onNew, onLoad, children }: LibraryPanelProps) {
